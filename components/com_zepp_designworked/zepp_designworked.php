...
$url_path = JURI::root(true) . '/components/com_zepp_designworked/';
$document = JFactory::getDocument();
// Подключаем файл стилей
$document->addStyleSheet($url_path . '/css/zepp_designworked.css');
$document->addScript($url='/includes/js/joomla.javascript.js', $type = "text/javascript");
//$document->addScript($url_path .'js/example.js', $type = "text/javascript");
//$document->addScript($url_path . 'js/jquery.js', $type = "text/javascript");
