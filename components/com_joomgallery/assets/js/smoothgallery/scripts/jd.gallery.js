...
var gallery = {
  ...
  joomChangetext: function(element){
    ...
    {
      $('jg_photo_title').setHTML(element.title);
    }
    if($chk($('jg_photo_description')))
    {
      $('jg_photo_description').setHTML(element.description);
    }
    if($chk($('jg_photo_date')))
    {
      $('jg_photo_date').setHTML(element.date);
    }
    if($chk($('jg_photo_hits')))
    {
      $('jg_photo_hits').setHTML(element.hits);
    }
    if($chk($('jg_photo_rating')))
    {
      $('jg_photo_rating').setHTML(element.rating);
    }
    if($chk($('jg_photo_filesizedtl')))
    {
      $('jg_photo_filesizedtl').setHTML(element.filesizedtl);
    }
    if($chk($('jg_photo_filesizeorg')))
    {
      $('jg_photo_filesizeorg').setHTML(element.filesizeorg);
    }
    if($chk($('jg_photo_author')))
    {
      $('jg_photo_author').setHTML(element.author);
    }
    //JG end
  },
  clearTimer: function() {
