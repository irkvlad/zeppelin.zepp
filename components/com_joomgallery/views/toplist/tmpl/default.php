...
<?php $count = count($this->rows);
    ...
    <div class="jg_txtrow">
      <div class="sectiontableentry1">
        ...
        <?php echo JText::_('JGS_TOPLIST_NO_IMAGES'); ?>
      </div>
    </div>
<?php endif;
...
<?php     endif;
          if($this->params->get('show_favourites_icon') == 1): ?>
              <a href="<?php echo JRoute::_('index.php?task=addimage&id='.$row->id.'&toplist='.$this->type); ?>"<?php echo JHTML::_('joomgallery.tip', 'JGS_COMMON_FAVOURITES_ADD_IMAGE_TIPTEXT', 'JGS_COMMON_FAVOURITES_ADD_IMAGE_TIPCAPTION', true); ?>>
...
<?php     endif;
          if($this->params->get('show_favourites_icon') == 2): ?>
              <a href="<?php echo JRoute::_('index.php?task=addimage&id='.$row->id.'&toplist='.$this->type); ?>"<?php echo JHTML::_('joomgallery.tip', 'JGS_COMMON_DOWNLOADZIP_ADD_IMAGE_TIPTEXT', 'JGS_COMMON_DOWNLOADZIP_ADD_IMAGE_TIPCAPTION', true); ?>>
...
<?php     endif;
          if($this->params->get('show_report_icon') == 1): ?>
              <a href="<?php echo JRoute::_('index.php?task=report&id='.$row->id.'&toplist='.$this->type.'&tmpl=component'); ?>" class="modal<?php echo JHTML::_('joomgallery.tip', 'JGS_COMMON_REPORT_IMAGE_TIPTEXT', 'JGS_COMMON_REPORT_IMAGE_TIPCAPTION'); ?>" rel="{handler:'iframe'}"><!--, size:{x:200,y:100}-->
