...
<?php endif;
  ...
  <div class="jg_rmsm_legend">
    <div class="jg_rm">
      <?php echo JText::_('JGS_COMMON_REGISTERED_MEMBERS'); ?>: <?php echo  JText::_('JGS_COMMON_REGISTERED_MEMBERS_LONG'); ?>;
    </div>
    <div class="jg_sm">
      <?php echo JText::_('JGS_COMMON_SPECIAL_MEMBERS'); ?>: <?php echo  JText::_('JGS_COMMON_SPECIAL_MEMBERS_LONG'); ?>
    </div>
  </div>
<?php endif;
