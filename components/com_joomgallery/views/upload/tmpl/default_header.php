...
<?php endif;
  ...
  <div class="jg_search">
    <form action="<?php echo JRoute::_('index.php?view=search'); ?>" method="post">
      <input title="<?php echo JText::_('JGS_COMMON_SEARCH', true) ;?>" type="text" name="sstring" class="inputbox" onblur="if(this.value=='') this.value='<?php echo JText::_('JGS_COMMON_SEARCH', true) ;?>';" onfocus="if(this.value=='<?php echo  JText::_('JGS_COMMON_SEARCH', true) ;?>') this.value='';" value="<?php echo JText::_('JGS_COMMON_SEARCH') ;?>" />
    </form>
  </div>
<?php endif;
