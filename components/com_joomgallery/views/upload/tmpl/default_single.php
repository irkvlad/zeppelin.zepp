...
<?php endif;
      if($this->_config->get('jg_delete_original_user') == 2): ?>
      <div class="jg_uploadnotice small sectiontableentry2">
        <?php echo $sup2; ?>&nbsp;<?php echo JText::_('JG_UPLOAD_DELETE_ORIGINAL_AFTER_UPLOAD_ASTERISK'); ?>
      </div>
<?php endif;
      if($this->_config->get('jg_special_gif_upload') == 1): ?>
      <div class="jg_uploadnotice small sectiontableentry2">
        <?php echo $sup3; ?>&nbsp;<?php echo JText::_('JG_UPLOAD_CREATE_SPECIAL_GIF_ASTERISK'); ?>
      </div>
<?php endif;
      if($this->_config->get('jg_redirect_after_upload')): ?>
      <div>
        <b><?php echo JText::_('JGS_DEBUG_MODE_ASTERISK'); ?></b>
      </div>
<?php endif; ?>
      <div>
