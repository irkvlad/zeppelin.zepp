...
echo $this->loadTemplate('header'); ?>
  <div class="jg_searchview">
    <div class="sectiontableheader">
      <?php echo JText::sprintf('JGS_SEARCH_RESULTS_FOR', '<b>'.$this->sstring.'</b>'); ?>
    </div>
<?php $count = count($this->rows);
    ...
    <div class="jg_txtrow">
      <div class="sectiontableentry1">
        ...
        <?php echo JText::_('JGS_SEARCH_RESULTS_NO_IMAGES'); ?>
      </div>
    </div>
<?php endif;
      ...
      <div class="jg_searchelement">
        <div class="jg_imgalign_search">
          <div class="jg_searchelem_photo">
            <a title="<?php echo $row->imgtitle; ?>" href="<?php echo $row->link; ?>">
...
<?php           break;
              case 1: ?>
              <?php echo $row->comments.' '.JText::_('JGS_COMMON_COMMENT'); ?>
<?php           break;
              default: ?>
...
<?php     endif;
          if($this->params->get('show_favourites_icon') == 1): ?>
              <a href="<?php echo JRoute::_('index.php?task=addimage&id='.$row->id.'&sstring='.$this->sstring); ?>"<?php echo JHTML::_('joomgallery.tip', 'JGS_COMMON_FAVOURITES_ADD_IMAGE_TIPTEXT', 'JGS_COMMON_FAVOURITES_ADD_IMAGE_TIPCAPTION', true); ?>>
...
<?php     endif;
          if($this->params->get('show_favourites_icon') == 2): ?>
              <a href="<?php echo JRoute::_('index.php?task=addimage&id='.$row->id.'&sstring='.$this->sstring); ?>"<?php echo JHTML::_('joomgallery.tip', 'JGS_COMMON_DOWNLOADZIP_ADD_IMAGE_TIPTEXT', 'JGS_COMMON_DOWNLOADZIP_ADD_IMAGE_TIPCAPTION', true); ?>>
...
<?php     endif;
          if($this->params->get('show_report_icon') == 1): ?>
              <a href="<?php echo JRoute::_('index.php?task=report&id='.$row->id.'&sstring='.$this->sstring.'&tmpl=component'); ?>" class="modal<?php echo JHTML::_('joomgallery.tip', 'JGS_COMMON_REPORT_IMAGE_TIPTEXT', 'JGS_COMMON_REPORT_IMAGE_TIPCAPTION'); ?>" rel="{handler:'iframe'}"><!--, size:{x:200,y:100}-->
