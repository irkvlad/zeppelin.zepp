<?php defined('_JEXEC') or die('Restricted access');
      ...
      if($this->extended > 0):
        echo $this->sliders->startPanel(JText::_('JGS_MINI_EXTENDED'), 'param-page-images-options'); ?>
  ...
  <div class="joomgallery-slider">
    <div class="jg_bu_extended_options">
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_TYPE'); ?>::<?php echo JText::_('JGS_MINI_TYPE_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_TYPE'); ?></span>
      </div>
      ...
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_POSITION'); ?>::<?php echo JText::_('JGS_MINI_POSITION_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_POSITION'); ?></span>
      </div>
      <div class="jg_bu_option_value">
      ...
      <div class="jg_clearboth"></div>
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_LINKED'); ?>::<?php echo JText::_('JGS_MINI_LINKED_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_LINKED'); ?></span>
      </div>
      <div class="jg_bu_option_value">
      ...
      <div id="jg-image-linkedimagetype-options"<?php echo ($this->params->get('default_type', 'thumb') != 'thumb' || $this->params->get('default_linked', 1) != 1 || $this->params->get('openimage') == 0 || ($this->params->get('openimage') == 'default' && $this->_config->get('jg_detailpic_open') == 0)) ? ' class="jg_displaynone"' : ''; ?>>
        <div class="jg_bu_option_key">
          <span title="<?php echo JText::_('JGS_MINI_LINKED_IMAGE_TYPE'); ?>::<?php echo JText::_('JGS_MINI_LINKED_IMAGE_TYPE_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_LINKED_IMAGE_TYPE'); ?></span>
        </div>
        <div class="jg_bu_option_value">
      ...
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_ALTTEXT'); ?>::<?php echo JText::_('JGS_MINI_ALTTEXT_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_ALTTEXT'); ?></span>
      </div>
      <div class="jg_bu_option_value">
      ...
      <div class="jg_clearboth"></div>
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_ADD_CLASS'); ?>::<?php echo JText::_('JGS_MINI_ADD_CLASS_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_ADD_CLASS'); ?></span>
      </div>
      <div class="jg_bu_option_value">
      ...
      <div class="jg_clearboth"></div>
      <div class="jg_bu_option_key">
        <span title="<?php echo JText::_('JGS_MINI_TEXTLINK'); ?>::<?php echo JText::_('JGS_MINI_TEXTLINK_TIP'); ?>" class="hasTip"><?php echo JText::_('JGS_MINI_TEXTLINK'); ?></span>
      </div>
      <div class="jg_bu_option_value">
...
<?php   echo $this->sliders->endPanel();
      ...
      echo $this->sliders->startPanel(JText::_('JGS_MINI_SEARCH'), 'param-page-images-search'); ?>
  <script type="text/javascript">
...
<?php endif; ?>
  ...
  <div class="joomgallery-slider">
    <div class="jg_bu_search">
      <form action="<?php echo JRoute::_('index.php?view=mini&tmpl=component&e_name='.$this->e_name.'&object='.JRequest::getVar('object')); ?>" name="adminForm" method="post" onsubmit="javascript:ajaxRequest('<?php echo JRoute::_('index.php?view=mini&format=raw', false); ?>', 1, 'search=' + this.search.value); return false;">
        <div class="pagination">
          ...
          <div class="jg_clearboth">
            <span class="jg_bu_limit">
              <?php echo JText::_('Display Num').$this->lists['limit']; ?>
            </span>
            <span class="jg_bu_searchfield">
              <?php echo JText::_('JGS_MINI_SEARCH_IMAGE'); ?>
...
<?php if($this->extended != -1): ?>
        <div class="jg_bu_filter jg_clearboth">
          <?php echo JText::_('JGS_MINI_FILTER_BY_CATEGORY'); ?>
