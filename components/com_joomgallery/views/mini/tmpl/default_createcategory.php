<?php defined('_JEXEC') or die('Restricted access'); ?>
  <div class="jg-slider jg_uploadform">
    <form action="<?php echo JRoute::_('index.php?task=savecategory&tmpl=component&redirect='.base64_encode('index.php?view=mini&tmpl=component')); ?>" method="post" name="CreateCategoryForm" onsubmit="return joom_categoryCheck()">
      <div class="jg_uprow">
        <div class="jg_uptext hasTip" title="<?php echo JText::_('JGS_MINI_CATEGORY_NAME'); ?>::<?php echo JText::_('JGS_MINI_CATEGORY_NAME_DESCRIPTION'); ?>">
          <?php echo JText::_('JGS_MINI_CATEGORY_NAME'); ?>
        </div>
