<?php defined('_JEXEC') or die('Restricted access');
        ...
        #echo $this->sliders->startPanel(JText::_('JGS_MINI_EXTENDED'), 'param-page'); ?>
  <div class="jg-slider jg_uploadform">
    <form action="<?php echo JRoute::_('index.php?controller=upload&task=upload&type=single&tmpl=component&redirect='.base64_encode('index.php?view=mini&tmpl=component')); ?>" method="post" name="SingleUploadForm" enctype="multipart/form-data" onsubmit="return joom_singleuploadcheck()" >
      <?php /*for($i = 0; $i < $this->inputcounter; $i++):*/ ?>
      <div class="jg_uprow">
        <div class="jg_uptext">
          <?php echo JText::_('JGS_COMMON_PLEASE_SELECT_IMAGE'); ?>
        </div>
...
<?php /*endfor;*/ ?>
      <div class="jg_uprow">
        <div class="jg_uptext hasTip" title="<?php echo JText::_('JGS_COMMON_TITLE'); ?>::<?php echo JText::_('JGS_MINI_TITLE_DESCRIPTION'); ?>">
...
<?php endif; ?>
      <div class="jg_uprow">
        ...
        <!--<input type="button" name="button" value="<?php echo JText::_('JGS_UPLOAD_AND_INSERT'); ?>" class="button"
