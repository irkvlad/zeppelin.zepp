...
echo $this->loadTemplate('header'); ?>
  ...
  <div class="jg_editpicture">
    <form action = "<?php echo JRoute::_('index.php?task=save'.$this->redirect.$this->slimitstart); ?>" method="post" name="adminForm"
...
<?php $url = !empty($this->redirecturl) ? JRoute::_($this->redirecturl) : JRoute::_('index.php?view=userpanel'.$this->slimitstart, false); ?>
      <input type="button" name="Button" value="<?php echo JText::_('JGS_COMMON_CANCEL'); ?>"
        onclick = "javascript:location.href='<?php echo $url; ?>';" />
    </div>
