...
<input type="hidden" name="id" value="<?php echo $id ?>" />
			...
			<table class="admintable">
				<tr>
					...
					<td valign="top" width="60">
						<input class="text_area" type="text" name="name" id="name" size="60" maxlength="80"
							value="<?php echo $this->client->name ?>" /></td> <td width="200">&nbsp;</td>
				...
				<tr>
					...
					<td valign="top" width="60">
						<?php echo JHTML::_('select.integerlist', -5, 5, 1, "likes", $attribs = null, $selected = $this->client->likes , $format = ""); ?>
					</td></tr>
				<tr>
					<td class="key1"><?php echo JText::_('Менеджер'); ?></td>
					<td valign="top" width="60">
<?php				echo JHTML::_('select.genericlist', $this->listManager, $name = 'modifer_user', $attribs = null, $key = 'value', $text = 'text', $selected = $this->client->modifer_user );  ?>
		...
		<?php        foreach($this->contact as $contact) {  ?>
		        <tr class="client">
					...
					<td valign="top" width="60">
						<input class="text_area" type="text" name="town[]" id="town" size="60" maxlength="60" value="<?php echo $contact->town ?>" />
					</td>

					<td valign="top" width="60">
						<input class="text_area" type="text" name="post[]" id="post" size="60" maxlength="60" value="<?php echo $contact->post ?>" />
					</td>

					<td valign="top" width="60">
						<input class="text_area" type="text" name="telefon[]" id="telefon" size="60" maxlength="60" value="<?php echo $contact->telefon ?>" />
					</td>

					<td valign="top" width="60">
						<input class="text_area" type="text" name="fio[]" id="fio" size="60" maxlength="40" value="<?php echo $contact->fio ?>" />
					</td>

					<td valign="top" width="60">
						<input class="text_area" type="text" name="email[]" id="email" size="60" maxlength="40" value="<?php echo $contact->email ?>" />
					</td>
...
<?php
	//print_R($id,false);    print_R($idc,false);