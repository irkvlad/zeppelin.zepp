	...
	<table class="admintable">
		<tr>
			<td rowspan="8" class="key2">
				<img width="256" id="logo" src="<?php echo $this->row->logo_path; ?>" alt="Фото" />
			...
			<td rowspan="3" class="key2" valign="top" >
				...
				<?php
					...
					<input type="checkbox" name="thri_d" value="1" <?php echo $checked1; ?> >3D Max<br>
					<input type="checkbox" name="photoshop" value="1" <?php echo $checked2; ?> >Photo Shop<br>
					<input type="checkbox" name="corel" value="1" <?php echo $checked3; ?> >Corel<br>
					<input type="checkbox" name="auto_cad" value="1" <?php echo $checked4; ?> >Auto Cad<br>
					<input type="checkbox" name="web_disign" value="1" <?php echo $checked5; ?> >Web - дизайн
                </div>
                <div style='width : 120px;float:left;'>  <b >Выбрать</b>
				<?php
                      echo $this->starGroup    ;?>
                     <br />  <font size="15" color="#ffcc00" ><?php
		...
		<tr>
			...
			<td valign="top" width="60">
				<input class="text_area" type="text" name="fio" id="fio" size="60" maxlength="40" value="<?php echo $this->row->fio; ?>" />
			</td>
		</tr>
		...
		<tr>
			...
			<td valign="top" width="60">
				<input class="date_rojjdeniy" type="text" name="date_rojjdeniy" id="date_rojjdeniy" size="60" maxlength="10" value="<?php echo $this->row->date_rojjdeniy; ?>" />
                </td>
            <td rowspan="8" class="key1" valign="top" width="60" higth="100">
                <span class="key1">Характеристика</span><br />
                <textarea class="text_area" rows="27" cols="45" name="privut_notes" id="privut_notes" style="width: 330px; height: 405px;text-align: left;"><?php
		...
		<tr>
			<td valign="top" width="60" >
				<input class="text_area" type="text" name="telefon" id="telefon" size="60" maxlength="16" value="<?php echo $this->row->telefon; ?>" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td valign="top" width="60">
				<input class="text_area" type="text" name="email" id="email" size="60" maxlength="50" value="<?php echo $this->row->email; ?>" />
			</td>
		</tr>
		...
		<tr>
			...
			<td width="60">
				<textarea class="text_area" rows="4" cols="57" name="student" id="student" ><?php echo $this->student; ?></textarea>
		...
		<tr>
			...
			<td width="60">
				<textarea class="text_area" rows="4" cols="57" name="worcked" id="worcked" ><?php echo $this->worcked; ?></textarea>
		...
		<tr>
			...
			<td width="60">
				<textarea class="text_area" rows="11" cols="57" name="notes" id="notes" ><?php echo $this->notes; ?></textarea>
...
for ($i=0;$i<4;$i++){
    echo '<td valign="bottom">';
	 ...
	 echo '<img onclick=\'this.style.display="none";document.photo'.$i.'.src=this.src;document.getElementById("id'.$i.'").type = "hidden";document.getElementById("id'.$i.'").value = "del";\'
                style="';
  if(!$portfolio[$i]) echo 'display:none;';
  echo 'float:left;cursor:pointer" width="25" height="25" src="../administrator/components/com_portfolios/img/icon_error.gif" alt="Удалить" /><a href="'.$portfolio[$i].'" target="_blank">
        <img id="photo'.$i.'" width="150" height="150" src="'.$portfolio[$i].'"  /></a><br />';
