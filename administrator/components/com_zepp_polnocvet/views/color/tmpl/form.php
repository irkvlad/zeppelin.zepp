		...
		<table class="adminlist">
			...
			foreach ( $this->data as $row )	{
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td>
						<input class="text_area" type="text" name="name[]" id="name" size="20" maxlength="20" value="<?php echo $row->name; ?>" onchange="adminForm.<?php echo "cb$i" ; ?>.checked=true" />
					</td>
					<td>
						<input class="text_area" type="text" name="color[]" id="сolor" size="3" maxlength="3" value="<?php echo $row->color; ?>" onchange="adminForm.<?php echo "cb$i" ; ?>.checked=true" />
					</td>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<input class="text_area" type="text" name="name[]" id="name" size="20" maxlength="20" value='' onchange="adminForm.<?php echo "cb$i" ; ?>.checked=true" />
				</td>
				<td>
					<input class="text_area" type="text" name="color[]" id="color" size="3" maxlength="3" value='' onchange="adminForm.<?php echo "cb$i" ; ?>.checked=true" />
				</td>
