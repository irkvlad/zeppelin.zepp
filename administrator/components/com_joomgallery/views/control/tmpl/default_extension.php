<?php defined('_JEXEC') or die('Direct Access to this location is not allowed.'); ?>
  <div class="jg_updexistpanel">
    <div class="jg_updexisthead"><?php echo JText::sprintf('JGA_ADMENU_EXTENSION_NOT_UPTODATE', '<span style="font-weight:bold;">'.$this->name.'</span>'); ?></div>
...
<?php if(isset($this->extension['downloadlink'])): ?>
    <div class="jg_updexistdownload"><a href="<?php echo $this->extension['downloadlink']; ?>" target="_blank"><?php echo JText::_('JGA_ADMENU_DOWNLOAD_UPDATE_LINK'); ?></a></div>
<?php endif;
      if(isset($this->extension['updatelink'])):
        if($this->params->get('curl_loaded')): ?>
    <div class="jg_updexistauto"><?php echo JText::_('JGA_ADMENU_AUTOUPDATE_TEXT'); ?></div>
...
<?php   endif;
    ...
    <div class="jg_updexistautoform"><?php echo JText::_('JGA_ADMENU_AUTOUPDATE_TEXT'); ?>
...
<?php     endif;
          if(!$this->params->get('url_fopen_allowed')): ?>
    <div class="jg_updexistautonot"><?php echo JText::_('JGA_ADMENU_AUTOUPDATE_NOT_POSSIBLE'); ?></div>
<?php     endif;
        endif;
      endif; ?>
  </div>