<?php defined('_JEXEC') or die('Restricted access'); ?>
  <div class="jg-slider jg_uploadform">
    <form action="<?php echo JRoute::_('index.php?option='._JOOM_OPTION.'&controller=categories&task=save&tmpl=component&redirect='.base64_encode('index.php?option='._JOOM_OPTION.'&view=mini&tmpl=component')); ?>" method="post" name="CreateCategoryForm" onsubmit="return joom_categoryCheck()">
      <div class="jg_uprow">
        <div class="jg_uptext hasTip" title="<?php echo JText::_('JGA_MINI_CATEGORY_NAME'); ?>::<?php echo JText::_('JGA_MINI_CATEGORY_NAME_DESCRIPTION'); ?>">
          <?php echo JText::_('JGA_MINI_CATEGORY_NAME'); ?>
        </div>
      ...
      <div class="jg_uprow">
        <div class="jg_uptext">
          <input type="submit" value="<?php echo JText::_('JGA_MINI_SAVE'); ?>" class="button" />
        </div>
      </div>
