<?php defined('_JEXEC') or die('Restricted access');
        ...
        #echo $this->sliders->startPanel(JText::_('JGA_MINI_EXTENDED'), 'param-page'); ?>
...
<?php /*endfor;*/ 
      ...
      <div class="jg_uprow">
        <div class="jg_uptext hasTip" title="<?php echo JText::_('JGA_COMMON_TITLE'); ?>::<?php echo JText::_('JGA_COMMON_TITLE_DESCRIPTION'); ?>">
...
<?php endif; ?>
      ...
      <!--<div class="jg_uprow">
        <div class="jg_uptext">
          <?php echo JText::_('JGA_AUTHOR_OWNER'); ?>
        </div>
...
<?php endif; ?>
      <div class="jg_uprow">
        <div class="jg_uptext">
          <input type="submit" value="<?php echo JText::_('JGA_UPLOAD_UPLOAD'); ?>" class="button" />
        </div>
        <!--<input type="button" name="button" value="<?php echo JText::_('JGA_UPLOAD_AND_INSERT'); ?>" class="button"
