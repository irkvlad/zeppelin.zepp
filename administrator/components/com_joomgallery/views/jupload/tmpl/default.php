...
?>
      <td colspan="2" align="center">
        <applet name="JUpload" code="wjhk.jupload2.JUploadApplet" archive="<?php echo JURI::root(); ?>components/<?php echo _JOOM_OPTION; ?>/assets/java/wjhk.jupload.jar" width="800" height="600" mayscript>
