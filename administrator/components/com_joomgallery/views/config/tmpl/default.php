...
<?php
    ...
    JHTML::_('joomconfig.row', 'jg_use_real_paths', 'yesno', 'JGA_CONFIG_GS_PD_USE_REAL_PATHS', $this->_config->jg_use_real_paths);
...
JHTML::_('joomconfig.start', 'page4');
    ...
    JHTML::_('joomconfig.row', 'jg_useorigfilename', 'yesno', 'JGA_CONFIG_COMMON_ORIGINAL_FILENAME', $this->_config->jg_useorigfilename);
...
JHTML::_('joomconfig.start', 'page5');
    ...
    $list = JHTML::_('joomselect.users', 'jg_msg_upload_recipients[]', $arr_jg_msg_upload_recipients, false, array(-1 => JText::_('JGA_CONFIG_GS_MS_DEFAULT_RECIPIENTS')));
    ...
    JHTML::_('joomconfig.row', 'jg_msg_download_type', 'custom', 'JGA_CONFIG_GS_MS_DOWNLOAD_TYPE', $mc_jg_msg_download_type);
    ...
    $list = JHTML::_('joomselect.users', 'jg_msg_download_recipients[]', $arr_jg_msg_download_recipients, false, array(-1 => JText::_('JGA_CONFIG_GS_MS_DEFAULT_RECIPIENTS')));
    JHTML::_('joomconfig.row', 'jg_msg_download_recipients', 'custom', 'JGA_CONFIG_GS_MS_DOWNLOAD_RECIPIENTS', $list);
    JHTML::_('joomconfig.row', 'jg_msg_zipdownload', 'yesno', 'JGA_CONFIG_GS_MS_ZIPDOWNLOAD', $this->_config->jg_msg_zipdownload);
    ...
    $list = JHTML::_('joomselect.users', 'jg_msg_comment_recipients[]', $arr_jg_msg_comment_recipients, true, array(-1 => JText::_('JGA_CONFIG_GS_MS_DEFAULT_RECIPIENTS')));
    ...
    JHTML::_('joomconfig.row', 'jg_msg_nametag_type', 'custom', 'JGA_CONFIG_GS_MS_NAMETAG_TYPE', $mc_jg_msg_nametag_type);
    ...
    $list = JHTML::_('joomselect.users', 'jg_msg_nametag_recipients[]', $arr_jg_msg_nametag_recipients, true, array(-1 => JText::_('JGA_CONFIG_GS_MS_DEFAULT_RECIPIENTS')));
    JHTML::_('joomconfig.row', 'jg_msg_nametag_recipients', 'custom', 'JGA_CONFIG_GS_MS_NAMETAG_RECIPIENTS', $list);
    JHTML::_('joomconfig.row', 'jg_msg_nametag_totaggeduser', 'yesno', 'JGA_CONFIG_GS_MS_NAMETAG_TOTAGGEDUSER', $this->_config->get('jg_msg_nametag_totaggeduser'));
    JHTML::_('joomconfig.row', 'jg_msg_nametag_toowner', 'yesno', 'JGA_CONFIG_GS_MS_NAMETAG_TOOWNER', $this->_config->get('jg_msg_nametag_toowner'));
    ...
    $list = JHTML::_('joomselect.users', 'jg_msg_report_recipients[]', $arr_jg_msg_report_recipients, false, array(-1 => JText::_('JGA_CONFIG_GS_MS_DEFAULT_RECIPIENTS')));
...
JHTML::_('joomconfig.start', 'page7');
    ...
    JHTML::_('joomconfig.row', 'jg_usermaincat', 'yesno', 'JGA_CONFIG_UR_UU_USERMAINCATEGORY', $this->_config->jg_usermaincat);
    ...
    JHTML::_('joomconfig.row', 'jg_useruseorigfilename', 'yesno', 'JGA_CONFIG_COMMON_ORIGINAL_FILENAME', $this->_config->jg_useruseorigfilename);
    ...
    $redirect_after_upload[] = JHTML::_('select.option','0', JText::_('NO'));
    $redirect_after_upload[] = JHTML::_('select.option','1', JText::_('JGA_CONFIG_GS_BU_REDIRECT_AFTER_UPLOAD_TO_UPLOAD_VIEW'));
    $redirect_after_upload[] = JHTML::_('select.option','2', JText::_('JGA_CONFIG_GS_BU_REDIRECT_AFTER_UPLOAD_TO_USERPANEL'));
    $redirect_after_upload[] = JHTML::_('select.option','3', JText::_('JGA_CONFIG_GS_BU_REDIRECT_AFTER_UPLOAD_TO_GALLERY_VIEW'));
    ...
    JHTML::_('joomconfig.row', 'jg_redirect_after_upload', 'custom', 'JGA_CONFIG_GS_BU_REDIRECT_AFTER_UPLOAD', $mc_jg_redirect_after_upload);
JHTML::_('joomconfig.end');
...
JHTML::_('joomconfig.start', 'page10');
    ...
    JHTML::_('joomconfig.row', 'jg_imgalign', 'text', 'JGA_CONFIG_FS_GS_IMG_ALIGN', $this->_config->jg_imgalign);
    ...
    JHTML::_('joomconfig.row', 'jg_dyncropbgcol', 'text', 'JGA_CONFIG_FS_GS_DYNCROP_BGCOL', $this->_config->jg_dyncropbgcol);
    $hideemptycats[] = JHTML::_('select.option', 0, JText::_('NO'));
    $hideemptycats[] = JHTML::_('select.option', 1, JText::_('JGA_CONFIG_FS_GS_HIDE_ONLY_COMPLETELY_EMPTY_CATEGORIES'));
    $hideemptycats[] = JHTML::_('select.option', 2, JText::_('JGA_CONFIG_FS_GS_HIDE_ALL_EMPTY_CATEGORIES'));
    ...
    JHTML::_('joomconfig.row', 'jg_hideemptycats', 'custom', 'JGA_CONFIG_FS_GS_HIDE_EMPTY_CATEGORIES', $mc_jg_hideemptycats);
JHTML::_('joomconfig.end');
...
JHTML::_('joomconfig.start', 'page13');
    ...
    JHTML::_('joomconfig.row', 'jg_showallpicstoadmin', 'yesno', 'JGA_CONFIG_FS_UP_ALLIMAGESTOADMIN', $this->_config->jg_showallpicstoadmin);
...
JHTML::_('joomconfig.start', 'page15');
    ...
    JHTML::_('joomconfig.row', 'jg_ctalign', 'custom', 'JGA_CONFIG_COMMON_THUMBALIGN', $mc_jg_ctalign);
...
JHTML::_('joomconfig.start', 'page16');
    JHTML::_('joomconfig.row', 'jg_category_rss', 'text', 'JGA_CONFIG_CV_CS_RSS', $this->_config->jg_category_rss);
    ...
    JHTML::_('joomconfig.row', 'jg_catthumbalign', 'custom', 'JGA_CONFIG_CV_GS_CATEGORY_THUMBALIGN', $mc_jg_catthumbalign);
    ...
    JHTML::_('joomconfig.row', 'jg_showcategoryfavourite', 'yesno', 'JGA_CONFIG_COMMON_FAVOURITES_LINK', $this->_config->jg_showcategoryfavourite);
    ...
    JHTML::_('joomconfig.row', 'jg_category_report_images', 'custom', 'JGA_CONFIG_COMMON_REPORT_IMAGES', $mc_jg_categoryreportimages);
    JHTML::_('joomconfig.row', 'jg_showcategoryeditorlinks', 'yesno', 'JGA_CONFIG_COMMON_EDITOR_LINKS', $this->_config->jg_showcategoryeditorlinks);
JHTML::_('joomconfig.end');
...
JHTML::_('joomconfig.start', 'page17');
    ...
    JHTML::_('joomconfig.row', 'jg_subcatthumbalign', 'custom', 'JGA_CONFIG_COMMON_THUMBALIGN', $mc_jg_subcatthumbalign);
...
JHTML::_('joomconfig.start', 'page18');
    ...
    JHTML::_('joomconfig.row', 'jg_disabledetailpage', 'yesno', 'JGA_CONFIG_DV_GS_DISABLE_DEFAULT_DETAIL_VIEW', $this->_config->jg_disabledetailpage);
    ...
    JHTML::_('joomconfig.row', 'jg_detail_report_images', 'custom', 'JGA_CONFIG_COMMON_REPORT_IMAGES', $mc_jg_detailreportimages);
    ...
    JHTML::_('joomconfig.row', 'jg_showdetaileditorlinks', 'yesno', 'JGA_CONFIG_COMMON_EDITOR_LINKS', $this->_config->jg_showdetaileditorlinks);
...
JHTML::_('joomconfig.start', 'page21');
    ...
    $joom_repetitions[] = JHTML::_('select.option','0', JText::_('JGA_CONFIG_DV_SL_REPEAT_ENDLESS'));
    $joom_repetitions[] = JHTML::_('select.option','1', JText::_('JGA_CONFIG_DV_SL_REPEAT_ASK'));
    $joom_repetitions[] = JHTML::_('select.option','2', JText::_('JGA_CONFIG_DV_SL_REPEAT_STOP'));
    ...
    JHTML::_('joomconfig.row', 'jg_slideshow_repeat', 'custom', 'JGA_CONFIG_DV_SL_REPETITION', $mc_jg_repetitions);
JHTML::_('joomconfig.end');
...
JHTML::_('joomconfig.start', 'page24');
    ...
    $showtoplistdownload[] = JHTML::_('select.option','0', JText::_('JGA_CONFIG_COMMON_OPTION_NO_DISPLAY'));
    $showtoplistdownload[] = JHTML::_('select.option','1', JText::_('JGA_CONFIG_COMMON_OPTION_TO_RMSM'));
    $showtoplistdownload[] = JHTML::_('select.option','2', JText::_('JGA_CONFIG_COMMON_OPTION_TO_SM'));
    $showtoplistdownload[] = JHTML::_('select.option','3', JText::_('JGA_CONFIG_COMMON_OPTION_TO_ALL'));
    $mc_jg_showtoplistdownload = JHTML::_('select.genericlist', $showtoplistdownload, 'jg_showtoplistdownload', 'class="inputbox" size="4"', 'value', 'text', $this->_config->jg_showtoplistdownload);
    JHTML::_('joomconfig.row', 'jg_showtoplistdownload', 'custom', 'JGA_CONFIG_COMMON_DOWNLOAD', $mc_jg_showtoplistdownload);
    JHTML::_('joomconfig.row', 'jg_showtoplistfavourite', 'yesno', 'JGA_CONFIG_COMMON_FAVOURITES_LINK', $this->_config->jg_showtoplistfavourite);
    $toplistreportimages[] = JHTML::_('select.option','0', JText::_('JGA_CONFIG_COMMON_OPTION_NO_DISPLAY'));
    $toplistreportimages[] = JHTML::_('select.option','1', JText::_('JGA_CONFIG_COMMON_ONLY_REGUSERS'));
    $toplistreportimages[] = JHTML::_('select.option','2', JText::_('JGA_CONFIG_COMMON_REG_AND_UNREGUSERS'));
    $mc_jg_toplistreportimages = JHTML::_('select.genericlist', $toplistreportimages, 'jg_toplist_report_images', 'class="inputbox" size="3"', 'value', 'text', $this->_config->jg_toplist_report_images);
    JHTML::_('joomconfig.row', 'jg_toplist_report_images', 'custom', 'JGA_CONFIG_COMMON_REPORT_IMAGES', $mc_jg_toplistreportimages);
    JHTML::_('joomconfig.row', 'jg_showtoplisteditorlinks', 'yesno', 'JGA_CONFIG_COMMON_EDITOR_LINKS', $this->_config->jg_showtoplisteditorlinks);
JHTML::_('joomconfig.end');
...
JHTML::_('joomconfig.start', 'page25');
    ...
    $showfavouritesdownload[] = JHTML::_('select.option','0', JText::_('JGA_CONFIG_COMMON_OPTION_NO_DISPLAY'));
    $showfavouritesdownload[] = JHTML::_('select.option','1', JText::_('JGA_CONFIG_COMMON_OPTION_TO_RMSM'));
    $showfavouritesdownload[] = JHTML::_('select.option','2', JText::_('JGA_CONFIG_COMMON_OPTION_TO_SM'));
    $showfavouritesdownload[] = JHTML::_('select.option','3', JText::_('JGA_CONFIG_COMMON_OPTION_TO_ALL'));
    $mc_jg_showfavouritesdownload = JHTML::_('select.genericlist', $showfavouritesdownload, 'jg_showfavouritesdownload', 'class="inputbox" size="4"', 'value', 'text', $this->_config->jg_showfavouritesdownload);
    JHTML::_('joomconfig.row', 'jg_showfavouritesdownload', 'custom', 'JGA_CONFIG_COMMON_DOWNLOAD', $mc_jg_showfavouritesdownload);
    JHTML::_('joomconfig.row', 'jg_showfavouriteseditorlinks', 'yesno', 'JGA_CONFIG_COMMON_EDITOR_LINKS', $this->_config->jg_showfavouriteseditorlinks);
JHTML::_('joomconfig.end');
...
$this->tabs->startNestedTab(JText::_('JGA_CONFIG_TAB_SEARCH_SETTINGS'));
// start nineth nested tabs pane
$this->tabs->startPane('NestedPaneNine');
// start Tab "Search->General settings"
$this->tabs->startTab(JText::_('JGA_CONFIG_COMMON_TAB_GENERAL_SETTINGS'), 'nested-twentyeight');
...
JHTML::_('joomconfig.start', 'page28');
    ...
    JHTML::_('joomconfig.row', 'jg_search', 'custom', 'JGA_CONFIG_SS_GS_SEARCHFIELD', $mc_jg_search);
    JHTML::_('joomconfig.row', 'jg_searchcols', 'text', 'JGA_CONFIG_SS_GS_NUMB_COLUMN', $this->_config->jg_searchcols);
    $searchthumbalign[] = JHTML::_('select.option', '1', JText::_('JGA_COMMON_OPTION_FLUSH_LEFT'));
    $searchthumbalign[] = JHTML::_('select.option', '3', JText::_('JGA_COMMON_OPTION_CENTERED'));
    $searchthumbalign[] = JHTML::_('select.option', '2', JText::_('JGA_COMMON_OPTION_FLUSH_RIGHT'));
    ...
    JHTML::_('joomconfig.row', 'jg_searchthumbalign', 'custom', 'JGA_CONFIG_SS_GS_THUMBALIGN', $mc_jg_searchthumbalign);
    $searchtextalign[] = JHTML::_('select.option', '1', JText::_('JGA_COMMON_OPTION_FLUSH_LEFT'));
    $searchtextalign[] = JHTML::_('select.option', '3', JText::_('JGA_COMMON_OPTION_CENTERED'));
    $searchtextalign[] = JHTML::_('select.option', '2', JText::_('JGA_COMMON_OPTION_FLUSH_RIGHT'));
    ...
    JHTML::_('joomconfig.row', 'jg_searchtextalign', 'custom', 'JGA_CONFIG_SS_GS_TEXTALIGN', $mc_jg_searchtextalign);
    $showsearchdownload[] = JHTML::_('select.option','0', JText::_('JGA_CONFIG_COMMON_OPTION_NO_DISPLAY'));
    $showsearchdownload[] = JHTML::_('select.option','1', JText::_('JGA_CONFIG_COMMON_OPTION_TO_RMSM'));
    $showsearchdownload[] = JHTML::_('select.option','2', JText::_('JGA_CONFIG_COMMON_OPTION_TO_SM'));
    $showsearchdownload[] = JHTML::_('select.option','3', JText::_('JGA_CONFIG_COMMON_OPTION_TO_ALL'));
    $mc_jg_showsearchdownload = JHTML::_('select.genericlist', $showsearchdownload, 'jg_showsearchdownload', 'class="inputbox" size="4"', 'value', 'text', $this->_config->jg_showsearchdownload);
    JHTML::_('joomconfig.row', 'jg_showsearchdownload', 'custom', 'JGA_CONFIG_COMMON_DOWNLOAD', $mc_jg_showsearchdownload);
    JHTML::_('joomconfig.row', 'jg_showsearchfavourite', 'yesno', 'JGA_CONFIG_COMMON_FAVOURITES_LINK', $this->_config->jg_showsearchfavourite);
    $searchreportimages[] = JHTML::_('select.option','0', JText::_('JGA_CONFIG_COMMON_OPTION_NO_DISPLAY'));
    $searchreportimages[] = JHTML::_('select.option','1', JText::_('JGA_CONFIG_COMMON_ONLY_REGUSERS'));
    $searchreportimages[] = JHTML::_('select.option','2', JText::_('JGA_CONFIG_COMMON_REG_AND_UNREGUSERS'));
    $mc_jg_searchreportimages = JHTML::_('select.genericlist', $searchreportimages, 'jg_search_report_images', 'class="inputbox" size="3"', 'value', 'text', $this->_config->jg_search_report_images);
    JHTML::_('joomconfig.row', 'jg_search_report_images', 'custom', 'JGA_CONFIG_COMMON_REPORT_IMAGES', $mc_jg_searchreportimages);
    JHTML::_('joomconfig.row', 'jg_showsearcheditorlinks', 'yesno', 'JGA_CONFIG_COMMON_EDITOR_LINKS', $this->_config->jg_showsearcheditorlinks);
    JHTML::_('joomconfig.end');

// end Tab "Search->General settings"
$this->tabs->endTab();
// end nineth nested tabs pane NestedPaneNine
$this->tabs->endPane();
// end nineth nested MainTab "Search"
$this->tabs->endTab();
// end nested MainPane
$this->tabs->endPane();
?>
