...
<form action="index.php" method="post" name="adminForm" >
  <table cellpadding="4" cellspacing="0" border="0" width="100%">
    <tr>
      <td align="center">
        <b><?php echo JText::_('JGA_IMGMAN_MOVE_IMAGE_TO_CATEGORY'); ?></b><?php echo $this->lists['cats']; ?>
      </td>
    </tr>
  </table>
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
    <tr>
      <td align="left" valign="top" width="20%">
        <strong>
          <?php echo JText::_('JGA_IMGMAN_IMAGES_TO_MOVE'); ?>
        </strong>
      </td>
    </tr>
  </table>
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
    <tr>
      ...
      <th align="left">
        <?php echo JText::_('JGA_IMGMAN_PREVIOUS_CATEGORY'); ?>
      </th>
    </tr>
