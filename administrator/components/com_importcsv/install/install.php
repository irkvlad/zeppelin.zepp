...
$rows = 0;
?>
<h2>Import CSV : <?php echo JText::_('Installed'); ?></h2>
<img src="http://www.erreurs404.net/fichiers/logo_importcsv.jpg" />
<p>For more information about Import CSV and XML go to <a href="http://www.erreurs404.net/labels/importcsv.html?piwik_campaign=ImportCSV_Install">http://www.erreurs404.net/labels/importcsv.html</a></p>
<p>Pour plus d'informations &agrave; propos de Import CSV and XML rendez vous sur <a href="http://www.erreurs404.net/labels/importcsv.html?piwik_campaign=ImportCSV_Install">http://www.erreurs404.net/labels/importcsv.html</a></p>
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			<td class="key" colspan="2"><?php echo 'Import CSV '.JText::_('Component'); ?></td>
