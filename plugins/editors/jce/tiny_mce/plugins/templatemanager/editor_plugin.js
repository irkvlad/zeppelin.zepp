		...
		init : function(ed, url) {
			...
			ed.addCommand('mceTemplate', function(ui) {
				ed.windowManager.open({
					file : ed.getParam('site_url') + 'index.php?option=com_jce&task=plugin&plugin=templatemanager&file=templatemanager',
					width : 750 + ed.getLang('templatemanager_delta_width', 0),
					height : 450 + ed.getLang('templatemanager_delta_height', 0),
					inline : 1
				}, {
					plugin_url : url
				});
			...
			// Register buttons
			ed.addButton('templatemanager', {title : 'templatemanager.desc', image : url + '/img/templatemanager.gif', cmd : 'mceTemplate'});
