...
class modJUNewsUltraHelper {
	...
	function getList(&$params) {
        ...
        foreach ( $rows as $row ) {
            ...
            //DATA
            if ($showDate){
                $lists[$i]->created     = JHTML::_('date', $row->modified, $data_format );
                $lists[$i]->df_d   = JHTML::_('date', $row->modified, $df_d );
                $lists[$i]->df_m   = JHTML::_('date', $row->modified, $df_m );
                $lists[$i]->df_y   = JHTML::_('date', $row->modified, $df_y );
            }
            //SHOW HITS
            if ($showHits){
